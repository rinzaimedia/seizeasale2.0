...
$("#deal_deach_form").submit(function(){
	$.ajax({ type: "POST",url: "<?php echo admin_url('deals/view_deal_ajax')?>",async: true,data: $("#deal_deach_form").serialize(), success: function(data)
		{
...
$("#select_all").change(function(){
	var sel_val=$("#select_all").attr('checked');
	$("#deals_list_container input:checkbox").each(function(){
		this.checked=sel_val;
	})
})
})
...
{
	$.ajax({ type: "POST",url: "<?php echo admin_url('deals/view_deal_ajax')?>",async: true,data: $("#deal_deach_form").serialize()+"&page="+page_id, success: function(data)
		{
			$("#deals_list_container").html(data);
		}
	})
...
function delet_all()
{
	...
	$.ajax({ type: "POST",url: "<?php echo admin_url('deals/delete_deal_ajax')?>",async: true,data: "check_box_value="+checed_val, success: function(data)
		{
